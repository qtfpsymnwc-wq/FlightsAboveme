...
// v140: adaptive radar polling to avoid OpenSky 429
...
let SCROLL5 = false;
// v140 UI upgrade on top of v48 baseline
...
function render(){
  ...
  if (!current){
    ...
    if (logoEl){
      ...
      setHTML("logo", logoSVGFromCallsign("")); 
    }
    return;
  }
  ...
  if (logoEl){
    ...
    setHTML("logo", logoSVGFromCallsign(current.callsign));
  }
...
function start(){
  document.getElementById("fw-version").textContent = "v140";
  hookControls();
