...
/* ROUTE: wiring v106 (safe, no global const conflicts) */
if (!window.__FW_ROUTE_WIRED__) {
  window.__FW_ROUTE_WIRED__ = true;
...
function start(){
  document.getElementById("fw-version").textContent = "v108";
  hookControls();
