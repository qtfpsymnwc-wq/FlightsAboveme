...
// v137: adaptive radar polling to avoid OpenSky 429
...
let SCROLL5 = false;
// v137 UI upgrade on top of v48 baseline
...
function start(){
  document.getElementById("fw-version").textContent = "v137";
  hookControls();
