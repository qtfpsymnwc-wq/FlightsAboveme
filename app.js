...
const AIRPORT_CITY = {
  ...
  FSM:"Fort Smith, AR", TUL:"Tulsa, OK", MKO:"Muskogee, OK", JLN:"Joplin, MO", SGF:"Springfield, MO",
  // Major US (sample set; easy to extend)
  ...
  LAX:"Los Angeles, CA", SFO:"San Francisco, CA", SAN:"San Diego, CA", SJC:"San Jose, CA",
  SEA:"Seattle, WA", PDX:"Portland, OR", PHX:"Phoenix, AZ", LAS:"Las Vegas, NV",
  JFK:"New York, NY", LGA:"New York (LaGuardia), NY", EWR:"Newark, NJ", BOS:"Boston, MA",
  MIA:"Miami, FL", FLL:"Fort Lauderdale, FL", MCO:"Orlando, FL", TPA:"Tampa, FL",
  PNS:"Pensacola, FL", VPS:"Destin/Ft Walton Beach, FL", SRQ:"Sarasota, FL", RSW:"Fort Myers, FL",
  // Mexico/Caribbean (sample)
  CUN:"Cancún, MX", SJD:"San José del Cabo, MX", PUJ:"Punta Cana, DO", MBJ:"Montego Bay, JM",
  NAS:"Nassau, BS", AUA:"Aruba, AW", STT:"St. Thomas, VI", STX:"St. Croix, VI"
};
...
function render(){
  ...
  if (!current){
    ...
    setText("badge","≈");
    if (logoEl) setText("logo","✈");
    return;
  }

  setText("cs",(current.callsign || "UNKNOWN"));
  if (logoEl) setText("logo", logoTextFromCallsign(current.callsign));
...
function start(){
  document.getElementById("fw-version").textContent = "v54";
  hookControls();
